  ...
  router.get(
    ...
    async (req: Request, res: Response): Promise<void> => {
      ...
      try {
        ...
        const workspace = await workspaceManager.createWorkspaceFromText(
          content,
          getDefaultFilename(linter)
        );
    ...
    async (req: Request, res: Response): Promise<void> => {
      ...
      try {
        ...
        const options: LinterOptions = {
          ...
          ...(validatedBody.options.config_file && {
            config_file: validatedBody.options.config_file,
          }),
        ...
        if (validatedBody.content) {
          ...
          workspace = await workspaceManager.createWorkspaceFromText(
